    ...
    return(
        <div className="bg-transparent" id="Fiction">
            <div className="bg-transparent flex justify-between items-center px-10">
                ...
                <div>
                    <Link href={"/category/allFictionBooks"} className="text-amber-950 font-bold py-2 px-6 rounded-3xl hover:bg-amber-950 hover:opacity-80 hover:text-amber-100">See More</Link>
                </div>
            </div>
