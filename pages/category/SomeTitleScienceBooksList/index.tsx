...
function ScienceBooks(){
    ...
    const router=useRouter()
      ...
      function handleClick(event:React.MouseEvent<HTMLButtonElement>){
       ...
       router.push(`/category/SomeTitleScienceBooksList/${buttonValue}`) 
   ...
   const ScienceBooksList=allBooksList.filter(item=>item.category==="science")


    return(
        <div className="bg-transparent" id="Science">
           <div className="bg-transparent flex justify-between items-center px-10">
                <div id="pointer" className=" flex flex-col justify-center">
                    <p className=" text-amber-100 text-xl font-bold text-center">Category: Science</p>
                </div>
                <div>
            ...
            <div className=" grid grid-cols-4 gap-8 p-10">
                {
                    ScienceBooksList.slice(0,4).map((item,index)=>(
