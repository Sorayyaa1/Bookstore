...
function AllPoetryBooks(){
    ...
    const router=useRouter()
      ...
      function handleClick(event:React.MouseEvent<HTMLButtonElement>){
       ...
       router.push(`/category/SomeTitleScienceBooksList/AllScienceBooks/${buttonValue}`) 
   ...
   const PoetryBooksList=allBooksList.filter(item=>item.category==="science")


    return(
        <div className="bg-transparent">
           <div className="bg-amber-900 opacity-90">
                <h1 className="text-4xl text-amber-900 text-center py-8">All Science Books</h1>
            </div>
